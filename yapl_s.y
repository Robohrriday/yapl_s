...
#if DEBUG_PARSER
    #define TRACE_REDUCE(rule) printf("[REDUCE] %s\n", rule)
#else
...
type_specifier
	...
	| UNSIGNED | BOOL | COMPLEX | IMAGINARY
...
selection_statement
	: IF '(' expression ')' statement ELSE {ladder_len++;$6=(ladder_len-1);} statement {if(ladder_len>=max){max=ladder_len;} ladder_len=$6;} 
